...
source ~/Scratch/resnet_cifar100_nobn/resnet_env_nobn/bin/activate

# Run the Python script
python3 ~/Scratch/resnet_cifar100_nobn/train_resnet_cifar100_nobn.py
